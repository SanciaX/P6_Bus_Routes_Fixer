...
(error_dirs, error_directions, error_nodes_check, error_route, error_node_class, node_check_list_class, error_route_list_class, node12ok_class, fix_bus_route_class, num_of_routes, error_routes, error_nodes_type_check) = identify_errors(error_message_file, network_file_name_short)
...
new_mod_no1, this_mod_name1, mod_file_name1 = prepare_visum_transferfile(
...
modification_check, node_links, error_node_stop_list, num_of_node_stop, error_route_list_long, error_node_list1, error_route_list, num_of_nodes = get_node12ok_list(
    RouteNodes, ErrorNodeList, ErrorNodeStopList, ModificationCheckList,  route_added_transfer_file_start, network_file_name, network_file_name_short, error_modification, error_nodes_check, error_nodes_type_check, node12ok_class
)
...
all_messages, search_chains, nodes_delete_list, error_mod_transfer_file, routes_fixed_transfer_file = visum_path_search(
    working_scenario_delete_routes_name, error_modification, network_file_name, node_links, error_route_list, route_added_transfer_file_start, route_transfer_file_temp_name, fix_bus_route_class, route_added_transfer_file_final, modification_check
)
...
new_mod_no2, this_mod_name2, mod_file_name2, new_mod_no3, this_mod_name3, mod_file_name3, new_mod_set, cur_scenario_id, error_message_file_fixed = save_to_sm(
    this_project, error_mod_transfer_file, route_added_transfer_file_final, old_mod_set, new_mod_no1, error_message_dir, Visum
)
