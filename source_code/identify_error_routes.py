...
def identify_errors(error_message_file, network_file_name_short):
    ...
    error_node_class.read_error_file(error_route_list_class, node_check_list_class)
            ...
            # 4. the len of error_route equals to the number of lines of route error/warning message
    ...
    return error_dirs, error_directions, error_nodes_check, error_route, error_node_class, node_check_list_class, error_route_list_class, node12ok_class, fix_bus_route_class, num_of_routes, error_routes, error_nodes_type_check