...
def save_to_sm(this_project, error_mod_transfer_file, route_added_transfer_file_final, old_mod_set, new_mode_delete_routes, error_message_path, Visum):
    # new error_modification
    ...
    new_mod_set = old_mod_set[:-1] + str(new_mode_delete_routes) + "," + str(new_mod_no2) + "," + str(new_mod_no3)
    print(new_mod_set)
    ...
    error_message_file_fixed = error_message_path + str(cur_scenario_id) + ".txt"  # new error file
