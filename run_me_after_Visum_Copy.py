"""
# -*- coding: utf-8 -*-
This version is a short version of run_me.py, which omits openning the Visum scenario management and copying files to the working directory.,

Adapted from: run_me.py
